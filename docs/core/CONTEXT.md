...
| `get_children(name: str \| None = None)` | `list[ChildNode]`             | Get a list of all children defined under the same parent, if `name` is not provided, uses the current parent.             |
