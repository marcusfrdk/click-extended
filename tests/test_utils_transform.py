...
cases: list[Case] = [
    ...
    Case(
        value="test123case",
        snake_case="test_123_case",
        screaming_snake_case="TEST_123_CASE",
        camel_case="test123Case",
        pascal_case="Test123Case",
        kebab_case="test-123-case",
        train_case="Test-123-Case",
        flat_case="test123case",
        dot_case="test.123.case",
        title_case="Test 123 Case",
        path_case="test/123/case",
    ),
    Case(
        value="   spaces   around   ",
